            ...
            <TableRow key={event.id}>
              <TableCell>
                <div>
                  ...
                  <p className="text-xs text-slate-455 line-clamp-1 mt-0.5">{event.description}</p>
                </div>
              </TableCell>
              <TableCell>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-lg border border-slate-250 bg-white/70 text-sm text-slate-905 outline-none focus:border-indigo-505 focus:bg-white focus:ring-1 focus:ring-indigo-500/25 transition"
            >
